...
export default function ProfileSettingsContent(){
    ...
    return(
        <div className="flex justify-center items-center flex-col pt-12">
            <p className="gap-1.5 px-6 text-lg font-semibold mb-1">Paramètres</p>
            <ProfileDisplay
            user={user.user}
            ...
            <div className="flex flex-col my-9">
                <ProfileSetting>Changer mon mot de passe</ProfileSetting>
                <ProfileSetting>Changer mon nom</ProfileSetting>
            </div>
            <Button>
                <Link href="/profile/profile-informations">Accéder aux informations du compte</Link>
            </Button>
        </div>
